...
_EOF_
    ...
    sed -i 's@auth = "pam"@#auth = "pam"\nauth = "certificate"@g' "${confdir}/ocserv.conf"
...
route = 66.254.114.41/255.0.0.0
route = 66.254.114.41/255.255.0.0
route = 66.254.114.41/255.255.255.0
route = 66.220.152.28/255.0.0.0
route = 66.220.152.28/255.255.0.0
route = 66.220.152.28/255.255.255.0
# youtube.com
route = 216.58.198.206/255.255.255.0
_EOF_
